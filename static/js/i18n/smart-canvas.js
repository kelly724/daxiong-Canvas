(function(){
    ...
    window.StudioI18n.register({
        ...
        "smart.assetImages": { zh: "媒体资产", en: "Media" },
        ...
        "smart.assetDropHint": { zh: "把图片、视频或音频拖到这里保存到当前文件夹", en: "Drop images, video, or audio here to save them" },
        "smart.assetEmpty": { zh: "这个文件夹还没有媒体素材。把画布里的图片、视频或音频拖进来保存。", en: "No media here yet. Drag images, video, or audio from the canvas into this folder." },
        ...
        "smart.shortcutPan": { zh: "拖动画布，或临时切换抓手", en: "Drag to pan, or hold Space for the hand tool" },
